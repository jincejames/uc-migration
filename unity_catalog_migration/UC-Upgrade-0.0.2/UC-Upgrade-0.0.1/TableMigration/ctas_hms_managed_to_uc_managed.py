...
from utils.table_utils import (get_hms_table_description, ctas_hms_managed_table_to_uc_managed)
...
# MAGIC %md
# MAGIC ### Migrate Mounted Tables to UC as Mounted Tables and check equality

# COMMAND ----------

ctas_hms_managed_table_to_uc_managed(spark, mounted_tables_descriptions, target_catalog, target_schema, target_table)